...
export function RiskIntelligence({ assessment }: { assessment: PortfolioRiskAssessment }) {
  ...
  return <section className="mt-6 rounded-2xl border border-[#bfd7c6] bg-[#f4f8f4] p-5" aria-label="Risk Intelligence">
    ...
    <p className="mt-4 text-xs text-[var(--muted)]">Current measured risk, not a price or return prediction. MARA may use this advisory intelligence in a later phase; it cannot move funds.</p>
  </section>;
}
